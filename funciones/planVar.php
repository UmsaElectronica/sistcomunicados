...
<h3 style="color:#FFcc00;">Complete los Espacios</h3>
  ...
  <div class="nuevo1">
		<label style="font-size: 16pt; color: #ffff00">Titulo:</label><input class="span2" type="text" name="titulo" required="on" value="<?php if (isset($_POST['titulo']))echo $_POST['titulo']?>" style="background-color:#ffffcc" placeholder="Titulo de Comunicado"><br>
	...
	<tr>
	<td><textarea class="span2" name="asunto" required="on" cols="50" rows="4" onKeyDown="valida_longitud()" onKeyUp="valida_longitud()" id="asunto" style="background-color:#fFffcc" placeholder="Máximo 250 caracteres"><?php if (isset($_POST['asunto']))echo $_POST['asunto']?></textarea></td>
	</tr>
	<tr>
    ...
    <label style="font-size: 16pt; color: #ffff00;">Lugar:</label><input class="span2" type="text" name="lugar" required="on" value="<?php if (isset($_POST['lugar']))echo $_POST['lugar']?>" style="background-color:#ffffcc;"><br>
...
if(isset($_POST['varios'])){
 ?>
  <br><img src="my_image_test.png" style="height: 500px;"><br>
  <?php
}
?>
