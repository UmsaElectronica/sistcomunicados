...
$img_obj=new IMG_PROCESS($font_file1,$font_file2,$font_file3,$font_file4,$font_file5,$font_file6,$font_size,$font_size_watermark,$path);
  ...
  <div class="nuevo1">
    ...
    <input class="span2" required="on" type="date" name="fecha"  step="1" style="background-color: #ccffff;" value="<?php if (isset($_POST['fecha']))echo $_POST['fecha']?>" placeholder="Ej. 2017-08-21">
    <p>
    <label style="font-size: 16pt; color: #0033cc;">Hora:</label>
    <input class="span2" required="on" value="<?php if (isset($_POST['hora']))echo $_POST['hora']?>" type="time" name="hora" max="20:00" min="07:30" step="1" style="background-color: #ccffff" placeholder="Ej. 10:30">
    ...
    ?>
    <select class="span2" required="on" name="aula" style="background-color: #ccffff" value="<?=$_POST['aula'] ?>">
    ...
    <label style="font-size: 16pt; color: #0033cc;">Autor:</label><input class="span2" required="on" type="text" value="<?php if (isset($_POST['autor']))echo $_POST['autor']?>" name="autor" style="background-color: #ccffff;"><br>
...
if(isset($_POST['examenes'])){
  ...
  ?>
      <input style=" font-size: 15pt; background-color: #0033cc; color:#ffffff;" type="Submit" value="Guardar" class="btn btn-primary" name="guardar" id="guardar">
      </div>
</form>
</body>
</html>
