...
$img_obj=new IMG_PROCESS($font_file1,$font_file2,$font_file3,$font_file4,$font_file5,$font_file6,$font_size,$font_size_watermark,$path);
  ...
  <form action="" method="POST" name="clases" id="clases">
    ...
    <label style="font-size: 16pt; color: #006600;">Autor:</label><input class="span2" required="on" value="<?php if (isset($_POST['autor']))echo $_POST['autor']?>" type="text" name="autor" id="autor" style="background-color: #ccff99"><br>
